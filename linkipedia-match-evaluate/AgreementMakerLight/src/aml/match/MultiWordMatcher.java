...
//Public Methods
	...
	public Alignment match(double thresh)
	{
		...
		{
			//System.out.println("Running Multi-Word Matcher1");
			...
			{
				//System.out.println("Running Multi-Word Matcher2");
				...
				{
					//System.out.println("Running Multi-Word Matcher3");
					String sw = sWords[i];
					String tw = tWords[i];
					...
					//System.out.println("this is the sw: "+sw);
					HashSet<String> sList = getAllWordForms(sw);
					//System.out.println("this is the slist: "+sList.size());
					HashSet<String> tList = getAllWordForms(tw);
					//System.out.println("this si the tlist: "+tList.size());
				...
				for(Integer srcId : sourceLex.getClasses(sName))
				{
					...
					{
						//System.out.println("Running Multi-Word Matcher4");
						...
						//System.out.println(sName +" <-> " + tName + " : "+ finalSim);
					}
				}
			}
		}
