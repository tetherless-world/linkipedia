...
import edu.rpi.tw.linkipedia.search.searching.EntityAnnotator;
...
public class EntityAnnotationServlet extends HttpServlet{
	
	EntityAnnotator annotator = null ;
	int validationSetNum = 7;
	  public EntityAnnotationServlet(String index, String surfaceIndex){
