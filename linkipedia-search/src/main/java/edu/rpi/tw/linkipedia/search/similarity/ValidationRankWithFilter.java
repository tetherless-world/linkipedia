...
public class ValidationRankWithFilter {
	...
	public ValidationRankWithFilter(IndexSearcher searcher){
		this.searcher = searcher;
		co_cache = new Hashtable<String, Float> ();
		dir_cache = new Hashtable<String, Float> ();
	}
	
	public ValidationRankWithFilter(IndexSearcher searcher, IndexSearcher labelSearcher){
		this.searcher = searcher;
	...
	public Annotation rank(ArrayList<Annotation> object, ArrayList<ArrayList<Annotation>> contexts, Hashtable<String, ArrayList<String>> context_table){
		...
		for(int i = 0 ; i < object.size(); i++){
			...
			//System.out.println(url1+" vs "+currentAnnotation.getKeyword()+": "+defaultNameSimilarity+" "+urlNameSimilarity+" "+urlNameSimilarity);
